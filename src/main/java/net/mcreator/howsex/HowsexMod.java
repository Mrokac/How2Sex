...
@Mod("howsex")
public class HowsexMod {
	public static final Logger LOGGER = LogManager.getLogger(HowsexMod.class);
	public static final String MODID = "howsex";
	...
	public HowsexMod() {
		...
		HowsexModBlockEntities.REGISTRY.register(bus);

		HowsexModMenus.REGISTRY.register(bus);
