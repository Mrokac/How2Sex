...
public class SiloGUIScreen extends AbstractContainerScreen<SiloGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("howsex:textures/screens/silo_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Silo", 6, 4, -12829636);
		this.font.draw(poseStack, "Missle", 35, 24, -12829636);
		this.font.draw(poseStack, "Coords", 35, 58, -12829636);
	}
